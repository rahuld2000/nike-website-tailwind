        ...
        <div className="flex w-full min-h-screen items-center max-md:flex-col ">
            <div className=" m-20 max-w-3xl max-h-6xl space-y-14">
                <div className="flex flex-col space-y-5">
                    ...
                    <h1 className="text-8xl font-semibold max-md:text-6xl">The New Arrival <span className="text-orange-500 mr-2">Nike</span>Shoes</h1>
                ...
                <div className="flex">
                    {shoes.map((shoes)=>(
                        <div key={shoes.thumbnail}>
                            <img  onClick={(shoes)=>{
                     console.log(shoes)
                        }} src={shoes.bigShoe} alt="" width="150px" />
                        </div>
                    ))}
                </div>
