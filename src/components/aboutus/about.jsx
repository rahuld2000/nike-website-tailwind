...
let About = () => {
    return (
        <div>
        <div className="flex w-full justify-center items-center space-x-80 mt-36">
            ...
            <div>
                <img src={shoe8} alt="shoes" width="450px" />
            </div>
        </div>
        <div className="flex w-full justify-center">
        <div className="flex space-x-10 text-center items-center mt-40 ">
            {
                services.map((services)=>(
        <div key={services.label} className="flex flex-col items-center space-y-3 shadow-3xl rounded-2xl h-72 p-14 w-[400px]">
